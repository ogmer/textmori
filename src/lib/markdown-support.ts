 ...
 *
 * lang-markdown は html/css/js のパーサまで連れてくるため重い。Markdown を
 * 開かない限り不要なので、markdown.ts から動的 import で遅延ロードする。
 */
...
export const markdownSupport: Extension = [markdown(), syntaxHighlighting(markdownHighlightStyle)];
